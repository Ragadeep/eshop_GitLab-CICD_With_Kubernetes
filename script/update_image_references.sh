...
VERSION="{{ var.VERSION }}"
ADSERVICE_TAG="{{ var.ADSERVICE_TAG }}"
CARTSERVICE_TAG="{{ var.CARTSERVICE_TAG }}"
CHECKOUTSERVICE_TAG="{{ var.CHECKOUTSERVICE_TAG }}"
CURRENCYSERVICE_TAG="{{ var.CURRENCYSERVICE_TAG }}"
EMAILSERVICE_TAG="{{ var.EMAILSERVICE_TAG }}"
FRONTEND_TAG="{{ var.FRONTEND_TAG }}"
LOADGENERATOR_TAG="{{ var.LOADGENERATOR_TAG }}"
PAYMENTSERVICE_TAG="{{ var.PAYMENTSERVICE_TAG }}"
PRODUCTCATALOGSERVICE_TAG="{{ var.PRODUCTCATALOGSERVICE_TAG }}"
RECOMMENDATIONSERVICE_TAG="{{ var.RECOMMENDATIONSERVICE_TAG }}"
SHIPPINGSERVICE_TAG="{{ var.RECOMMENDATIONSERVICE_TAG }}"
